...
- [ ] **Encryption and Decryption (Addressable)**
  - ✅ Encryption at rest (cloud provider block storage — e.g. EBS `gp3` on the aws-main EKS example; Longhorn for the on-prem profile)
  - ✅ Encryption in transit (TLS everywhere)
  - ✅ GCP Secret Manager for key management (via External Secrets Operator)
  - Location: `values/clusters/<cluster>/argocd/infrastructure.yaml`, `charts/security-baseline/`
...
- [ ] **Data Backup Plan (Required)**
  - ✅ Velero backup schedules (production-daily 14d, infrastructure-daily 30d, cluster-resources-weekly 90d)
  - ✅ Automated schedules
  - ✅ Monthly restore testing
  - Location: `charts/velero-resources/`, `values/clusters/<cluster>/argocd/infrastructure.yaml`

- [ ] **Disaster Recovery Plan (Required)**
  - ✅ DR procedures documented
  - ✅ RTO/RPO defined
  - ✅ Recovery scenarios tested
  - Document: [BACKUP_DR.md](../operations/BACKUP_DR.md)
...
- [ ] **Disposal (Required)**
  ...
  - ✅ Cloud block-storage volume deletion reclaims data (Longhorn secure erase on the on-prem profile)
...
- [x] Encryption at rest (cloud provider block storage — e.g. EBS `gp3` on the aws-main EKS example; Longhorn on-prem)
...
4. **Configuration Evidence**
   ...
   # 1. Storage class (cloud provider block storage — e.g. gp3 on the aws-main EKS example; longhorn on-prem)
