...
3. Gets LoadBalancer IP from Gateway Service: `203.0.113.10`
4. Creates DNS A record in Cloudflare:

   ```
   api.stg.example.com → 203.0.113.10
   ```
...
# level=info msg="Desired change: CREATE api.stg.example.com A [Id: /hostedzone/Z1234567890ABC]"
